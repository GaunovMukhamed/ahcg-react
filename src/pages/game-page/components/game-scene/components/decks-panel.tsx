...
const DecksPanel: React.FC<DecksPanelProps> = ({ className='', style }) => {
  return(
    <div style={style} className={"border-left-1 border-top-1 border-primary border-round border-noround-right border-noround-bottom pt-2 pl-2 flex flex-column justify-content-end h-min "+className}>
